...
class Node(BaseNode):
    ...
    def printt(self,index):
        print(index)
        print(self.n, self.ls, self.squared)
        for child in self.children:
            child.printt(index+1)
    ...
    def split_node(self):
        ...
        # two new leafs
        if not self.parent:#checking if parent
            node1 = Node()
        else:
            node1 = self
        node2 = Node()
